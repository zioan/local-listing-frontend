    ...
    <div className="text-white bg-gradient-to-r from-blue-500 to-purple-600">
      <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8 sm:py-24">
        ...
        <div className="max-w-3xl mx-auto">
          <form onSubmit={handleSearch} className="flex mt-1 rounded-md shadow-sm">
            <input
              type="text"
              name="search"
              id="search"
            ...
            <button
              type="submit"
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-yellow-400 border border-transparent rounded-r-md hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
